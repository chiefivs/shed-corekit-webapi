...
namespace Shed.CoreKit.WebApi.Manager.ProxyGenerator
{
    internal static class TypeHelper
    {
        private static Dictionary<string, object> localCacheGetMethodInfoCustomAttributes { get; } = new Dictionary<string, object>();
        private static Dictionary<string, object> localCacheIsSubclassOf { get; } = new Dictionary<string, object>();
        private static Dictionary<string, object> localCacheIsImplementingInterface { get; } = new Dictionary<string, object>();
        private static Dictionary<string, object> localCacheGetInterfaces { get; } = new Dictionary<string, object>();
        private static Dictionary<string, Tuple<bool, EventInfo>> localCacheGetEventInfo { get; } = new Dictionary<string, Tuple<bool, EventInfo>>();
        private static Dictionary<string, Tuple<bool, EventInfo>> localCacheHasEvent { get; } = new Dictionary<string, Tuple<bool, EventInfo>>();
        private static Dictionary<string, Tuple<bool, MethodInfo>> localCacheGetMethodInfo { get; } = new Dictionary<string, Tuple<bool, MethodInfo>>();
        private static Dictionary<string, Tuple<bool, PropertyInfo>> localCacheGetPropertyInfo { get; } = new Dictionary<string, Tuple<bool, PropertyInfo>>();
        ...
        public static bool IsImplementingInterface(Type toCheck, Type interfaceType)
        {
            ...
            object c = null;
            lock (localCacheIsImplementingInterface)
            {
